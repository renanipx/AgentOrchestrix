# CONTRACTS — Fase 2: Architect Agent

## 1. Entradas (Input)
- `runs/run-XXX/artifacts/task.md`

## 2. Saídas (Output)
- **`runs/run-XXX/artifacts/architecture.md`**: Documento em markdown contendo obrigatoriamente estas seções:
  ```markdown
  # System Design (Design do Sistema)
